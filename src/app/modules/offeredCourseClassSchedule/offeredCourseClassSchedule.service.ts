...
import { OfferedCourseClassScheduleFilters } from './offeredCourseClassSchedule.interface';
...
const insertIntoDB = async (
  ...
  await OfferedCourseClassScheduleUtils.checkFacultyAvaialble(data);
...
const getAllFromDB = async (
  filters: OfferedCourseClassScheduleFilters,
